...
if __name__ == "__main__":
    ...
    parser.add_argument("--rollout-scheduler", nargs="+", type=int, default=[5000, 100000, 1, 20],
    ...
    parser.add_argument("--data-scheduler", nargs="+", type=float, default=[5000, 100000, 0.0, 0.9],
