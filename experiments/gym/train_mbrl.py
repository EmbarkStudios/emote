...
from emote.memory.memory import MemoryWarmup
...
from experiments.gym.train_half_cheetah import _make_env
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default="mbrl_")
    ...
    callbacks += [MemoryWarmup(dataloader)]
