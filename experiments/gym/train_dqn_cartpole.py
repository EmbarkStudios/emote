...
if __name__ == "__main__":
    ...
    env = DictGymWrapper(AsyncVectorEnv([_make_env() for _ in range(arg.num_envs)]))
    ...
    optimizers = [
        QLoss(
            name="q1",
            q=online_q_net,
            opt=Adam(online_q_net.parameters(), lr=arg.lr),
            max_grad_norm=1,
        ),
    ]
    ...
    train_callbacks = optimizers + [
        QTarget(
            ...
            roll_length=arg.rollout_length,
        ),
